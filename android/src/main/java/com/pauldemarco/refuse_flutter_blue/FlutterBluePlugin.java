...
package com.pauldemarco.refuse_flutter_blue;
...
public class FlutterBluePlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, RequestPermissionsResultListener  {
    ...
    private static final String NAMESPACE = "plugins.pauldemarco.com/refuse_flutter_blue";
    ...
    public boolean onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_FINE_LOCATION_PERMISSIONS) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                pendingResult.error(
                        "no_permissions", "refuse_flutter_blue plugin requires location permissions for scanning", null);
                pendingResult = null;
                pendingCall = null;
            }
            return true;

...
class RefuseGuid {
  ...
  RefuseGuid._internal(List<int> bytes)
      : _bytes = bytes,
        _hashCode = _calcHashCode(bytes);

  RefuseGuid(String input) : this._internal(_fromString(input));

  RefuseGuid.fromMac(String input) : this._internal(_fromMacString(input));

  RefuseGuid.empty() : this._internal(new List.filled(16, 0));
  ...
  operator ==(other) => other is RefuseGuid && this.hashCode == other.hashCode;
